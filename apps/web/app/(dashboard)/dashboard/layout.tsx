...
const Navbar = ({ userDetails, navConfig }: { userDetails: any; navConfig: NavItem[] }) => (
  <header className="flex h-16 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6">
    <div className="w-full flex-1">
      <h1 className="text-lg font-semibold">Dashboard</h1>
    </div>
    <div className="ml-auto flex items-center gap-4">
      {/* Organization Switcher - Template placeholder */}
      <div className="flex items-center gap-2">
        <span className="text-sm text-muted-foreground">Organization:</span>
        <span className="text-sm font-medium">Sample Org</span>
      </div>
