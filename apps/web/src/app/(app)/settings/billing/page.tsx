...
export default function BillingSettingsPage() {
  ...
  return (
    <div className="container mx-auto py-8 space-y-8">
      ...
      {/* Usage Statistics - Temporarily disabled due to TypeScript type inference issues */}
      {/* TODO: Restore this section once type issues are resolved */}

      {/* Plan Features - Temporarily disabled due to TypeScript type inference issues */}
      {/* TODO: Restore this section once type issues are resolved */}
